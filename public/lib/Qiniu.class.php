<?php
require_once($_SERVER['DOCUMENT_ROOT'] . "/public/plugin/qiniusdk/autoload.php");
// 七牛API
class Qiniu
{
    /**
    ...
    */
    ...
    static public function crc32_file($file)
    {
     ...
     */
    static public function crc32_data($data)
    {
     ...
     */
    static public function json_decode($json, $assoc = false, $depth = 512)
    {
     ...
     */
    static public function entry($bucket, $key)
    {
        $en = $bucket;
        if (!empty($key)) {
            $en = $bucket . ':' . $key;
